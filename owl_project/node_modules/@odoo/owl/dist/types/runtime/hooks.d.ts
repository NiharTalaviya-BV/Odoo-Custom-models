...
declare type EffectDeps<T extends any[]> = T | (T extends [...infer H, never] ? EffectDeps<H> : never);
/**
 * @template T
 ...
 */
declare type Effect<T extends [...T]> = (...dependencies: EffectDeps<T>) => void | (() => void);
/**
 ...
 */
export declare function useEffect<T extends [...T]>(effect: Effect<T>, computeDependencies?: () => T): void;
/**
